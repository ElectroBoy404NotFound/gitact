...
JNIEXPORT jint JNICALL Java_me_electroboy404notfound_rv32ima_MiniRV32IMA_MiniRV32IMAStep(JNIEnv * env, jobject thisobj, jobject state, jlong elapsedUS, jint count) {
